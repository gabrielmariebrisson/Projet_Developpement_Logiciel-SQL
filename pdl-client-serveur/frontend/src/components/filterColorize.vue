...
const errorMessage = ref<string>('');
  ...
  function modifieImage_colorizeImage()
  {
    ...
    api.getAlgorithme_p1(props.id, "colorizeImage", inputValue_1)
    .then((data: Blob) => {
      lecture_data(data);
      if(want_picture){
          telechargement_image(data,props.id+"colorizeImage")
        }
        errorMessage.value='';
    })
    .catch(e => {
  ...
  <div class="container">
    ...
    <div class="actions">
      ...
      <div class="input-group">
        <input type="number" id="dataValue1"  placeholder="hue" min="0" max="250" required>
        <button @click="modifieImage_colorizeImage()" class="button button-primary">Appliquer</button>
      </div>
